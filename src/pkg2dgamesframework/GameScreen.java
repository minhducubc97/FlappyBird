...
public abstract class GameScreen extends JFrame implements KeyListener{
    ...
    public int CUSTOM_WIDTH  = 500; // value adjusted to screen scaling
    public int CUSTOM_HEIGHT = 500; // value adjusted to screen scaling
    
    private GameThread G_Thread;
    
    public static int MASTER_WIDTH = 500, MASTER_HEIGHT = 500; // screen sizes
